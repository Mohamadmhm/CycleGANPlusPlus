...
#### Connection Error:HTTPConnectionPool ([#230](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/230), [#24](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/24), [#38](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/38))
...
#### TypeError: Object of type 'Tensor' is not JSON serializable ([#258](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/258))
Similar errors: AttributeError: module 'torch' has no attribute 'device' ([#314](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/314))

The current code only works with PyTorch 0.4+. An earlier PyTorch version can often cause the above errors.

#### ValueError: empty range for randrange() ([#390](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/390), [#376](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/376), [#194](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/194))
...
#### Can I continue/resume my training? ([#350](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/350), [#275](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/275), [#234](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/234), [#87](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/87))
You can use the option `--continue_train`. Also set `--epoch_count` to specify a different starting epoch count. See more discussion in [training/test tips](https://github.com/junyanz/pytorch-CycleGANPlusPlus/blob/master/docs/tips.md#trainingtest-tips).

#### Why does my training loss not converge? ([#335](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/335), [#164](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/164), [#30](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/30))
...
#### How can I make it work for my own data (e.g., 16-bit png, tiff, hyperspectral images)? ([#309](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/309),  [#320](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/), [#202](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/202))
...
- Write your own custom data loader (It is easy as long as you know how to load your data with python). If you write a new data loader class, you need to change the flag `--dataset_mode` accordingly. Alternatively, you can modify the existing data loader. For aligned datasets, change this [line](https://github.com/junyanz/pytorch-CycleGANPlusPlus/blob/master/data/aligned_dataset.py#L41); For unaligned datasets, change these two [lines](https://github.com/junyanz/pytorch-CycleGANPlusPlus/blob/master/data/unaligned_dataset.py#L57).

- If you use visdom and HTML to visualize the results, you may also need to change the visualization code.

#### Multi-GPU Training ([#327](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/327), [#292](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/292), [#137](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/137), [#35](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/35))
...
#### Can I run the model on CPU? ([#310](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/310))
Yes, you can set `--gpu_ids -1`. See [training/test tips](tips.md) for more details.


#### Are pre-trained models available? ([#10](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/10))
Yes, you can download pretrained models with the bash script `./scripts/download_cyclegan_model.sh`. See [here](https://github.com/junyanz/pytorch-CycleGANPlusPlus#apply-a-pre-trained-model-cyclegan) for more details. We are slowly adding more models to the repo.

#### Out of memory ([#174](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/174))
...
- Then at test time, you can load only one generator to produce the results in a single direction. This greatly saves GPU memory as you are not loading the discriminators and the other generator in the opposite direction. You can probably take the whole image as input. You can do this using `--model test --dataroot [path to the directory that contains your test images (e.g., ./datasets/horse2zebra/trainA)] --model_suffix _A --preprocess none`. You can use either `--preprocess none` or `--preprocess scale_width --crop_size [your_desired_image_width]`. Please see the [model_suffix](https://github.com/junyanz/pytorch-CycleGANPlusPlus/blob/master/models/test_model.py#L16) and [preprocess](https://github.com/junyanz/pytorch-CycleGANPlusPlus/blob/master/data/base_dataset.py#L24) for more details.

#### RuntimeError: Error(s) in loading state_dict ([#812](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/812), [#671](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/671),[#461](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/461), [#296](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/296))
...
#### What is the identity loss? ([#322](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/322), [#373](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/373), [#362](https://github.com/junyanz/pytorch-CycleGANPlusPlus/pull/362))
...
#### The color gets inverted from the beginning of training ([#249](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/249))
...
#### For labels2photo Cityscapes evaluation, why does the pretrained FCN-8s model not work well on the original Cityscapes input images? ([#150](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/150))
...
#### How do I get the `ground-truth` numbers on the labels2photo Cityscapes evaluation? ([#150](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/150))
You need to resize the original Cityscapes images to 256x256 before running the evaluation code.

#### What is a good evaluation metric for CycleGAN? ([#730](https://github.com/pulls), [#716](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/716), [#166](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/166))
...
#### What dose the CycleGAN loss look like if training goes well? ([#1096](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/1096), [#1086](ttps://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/1086), [#288](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/288), [#30](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/30))
...
#### Using resize-conv to reduce checkerboard artifacts ([#190](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/190), [#64](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/64))
...
#### pix2pix/CycleGAN has no random noise z ([#152](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/152))
...
#### Experiment details (e.g., BW->color) ([#306](https://github.com/junyanz/pytorch-CycleGANPlusPlus/issues/306))
